...
## SVI calculation from census data
...
p18_e+p18_ep+
  plot_annotation(title = "Correlation coeff. for each variable",
    subtitle = "between calculated & CDC SVI in 2018")&
...
## Calculated vs. CDC SVI for 2020
...
p20_e+p20_ep+
  plot_annotation(title = "Correlation coeff. for each variable",
    subtitle = "between calculated & CDC SVI in 2020")&
  theme(plot.title = element_text(size = 15))
```
